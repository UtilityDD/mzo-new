   ...
   const FilterContent = ({ isMobile = false }) => (
      <div className={`space-y-8 ${isMobile ? 'p-6 pb-32' : ''}`}>
         ...
         <div className="space-y-3">
            ...
            <div className="relative group">
               ...
               <input
                  ...
                  placeholder={isMobile ? "Search..." : "Search data..."}
         ...
         <div className="space-y-6">
            ...
            <div className={`grid grid-cols-1 ${isMobile ? 'md:grid-cols-2' : 'xl:grid-cols-2'} gap-6`}>
               <div className="space-y-3">
         ...
         {/* Action Buttons - Only for Mobile Modal */}
         {isMobile && (
      ...
      <div className="flex h-full bg-gray-50 fade-in overflow-hidden">
         ...
         <aside className="hidden lg:block w-96 border-r border-gray-200 bg-white overflow-y-auto z-10 p-6 h-full shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)]">
            <div className="flex items-center justify-between mb-8">
               ...
               <div className="flex gap-2">
                  <button onClick={() => setFilters({})} className="text-[10px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-widest transition-colors">
                     Reset
                  </button>
               </div>
            </div>
         ...
         <div className="flex-1 flex flex-col h-full overflow-hidden">
            <div className="glass px-6 pt-10 pb-6 border-b border-gray-100 sticky top-0 z-30 premium-shadow shrink-0">
               <div className="flex justify-between items-start">
                  ...
                  <button
                     ...
                     className="lg:hidden w-12 h-12 rounded-2xl bg-white border border-gray-100 android-shadow flex items-center justify-center text-gray-400 hover:text-blue-600 transition-all active:scale-90"
                  >
            ...
            <div className="flex-1 overflow-y-auto pb-32">
               ...
               <div className="px-4 pt-6 space-y-8 max-w-lg mx-auto md:max-w-4xl lg:max-w-7xl w-full">
                  {/* KPI Grid */}
