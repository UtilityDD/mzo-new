         ...
         <div className="glass px-6 pt-10 pb-6 border-b border-gray-100 sticky top-0 z-30 premium-shadow">
            ...
            <div className="flex bg-gray-100/80 backdrop-blur p-1 rounded-2xl border border-gray-100">
               ...
               <button
                  onClick={() => {
                     setViewMode('list');
                     setDrillDownRow(null); // Clear drilldown if manually switching to full list
                  }}
               ...
               <div className="space-y-4">
                  <div className="flex justify-between items-center px-2">
                     ...
                     <span className="text-[10px] font-extrabold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full border border-blue-100">
                        {drillDownRow
                           ? data.filter(r => String(r[drillDownRow.key] || 'N/A') === drillDownRow.label).length
                           : data.length
                        } Total
                     </span>
                  </div>
                  ...
                  {loading && data.length === 0 ? (
                     ...
                     <div className="space-y-3">
                        {(drillDownRow
                           ? data.filter(r => String(r[drillDownRow.key] || 'N/A') === drillDownRow.label)
                           : data
